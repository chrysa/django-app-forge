...
You are a senior software engineer working on **django-app-forge**.
Write clean, maintainable, idiomatic, and secure code.

## Project Context

**Stack:** Python (Django, packaging via pyproject)
**Purpose:** Generate Django apps with a custom directory structure from a YAML spec.
**Default branch:** `main`
...
- Core is a Django management command (`forgeapps`) that scaffolds apps from a YAML spec; keep the generator deterministic and template-driven.
